...
// Number.parseInt() parses a string and returns a whole number. Spaces are allowed. Only the first number is returned.
// If the number cannot be converted, NaN is returned.
// This method is same as parseInt() Global jS Method, but why it is used is explained below:
/*
